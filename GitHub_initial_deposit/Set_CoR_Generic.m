...
Xparent = cross(SCAP_RS_clav-SCAP_IA_clav,SCAP_AA_clav-SCAP_IA_clav); Xparent = Xparent./norm(Xparent);
Xchild = cross(SCAP_RS-SCAP_IA,SCAP_AA-SCAP_IA); Xchild = Xchild./norm(Xchild);
